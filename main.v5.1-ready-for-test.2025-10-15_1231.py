...
from db import (
    ...
    delete_task_fuzzy, delete_task_by_index, create_list, move_entity, get_all_tasks, update_user_profile, get_user_profile, get_completed_tasks, search_tasks
)
...
{{ "action": "create|add_task|show_lists|show_tasks|show_all_tasks|mark_done|delete_task|delete_list|move_entity|search_entity|rename_list|update_profile|restore_task|show_completed_tasks|unknown",
    ...
    for obj in actions:
        ...
        if action == "create" and entity_type == "list" and obj.get("list"):
            ...
            try:
                ...
                if restored:
                    await update.message.reply_text(f"🔄 Задача *{title}* восстановлена в списке *{list_name}*.", parse_mode="Markdown")
                else:
