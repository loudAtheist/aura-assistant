...
• «Задачу купить продукты для холодильника надо перенести в список Домашние дела» → {{ "action": "move_entity", "entity_type": "task", "title": "Купить продукты для холодильника", "list": "<последний список>", "to_list": "Домашние дела" }}
